...
def get_client_ip(request: Request) -> str:
    """
    Securely determines the client IP.
    When behind a trusted proxy, it takes the rightmost IP in X-Forwarded-For
    to avoid spoofing by attacker-supplied leftmost values.
    """
