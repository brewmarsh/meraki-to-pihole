...
from app.clients.pihole_client import get_pihole_custom_dns_records, add_dns_record_to_pihole, delete_dns_record_from_pihole, add_or_update_dns_record_in_pihole
...
class TestPiholeClient(unittest.TestCase):
    ...
    def test_add_or_update_dns_record_in_pihole_add(self, mock_add, mock_delete):
        ...
        # Call the function
        existing_records = {}
        result = add_or_update_dns_record_in_pihole(self.pihole_url, self.api_key, "test.com", "1.2.3.4", existing_records)
    ...
    def test_add_or_update_dns_record_in_pihole_update(self, mock_add, mock_delete):
        ...
        result = add_or_update_dns_record_in_pihole(self.pihole_url, self.api_key, "test.com", "2.2.2.2", existing_records)
